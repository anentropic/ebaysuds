...
class EbaySuds(object):
    def __init__(self, wsdl_url=WSDL_URL, **kwargs):
        ...
        self.app_id = kwargs.get('app_id') or ebaysuds_config.get('keys', 'app_id')
        ...
        credentials.Credentials.AuthCert = kwargs.get('cert_id') or ebaysuds_config.get('keys', 'cert_id')
